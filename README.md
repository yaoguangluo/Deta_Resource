...
# 算法原理: 罗瑶光先生 于 2019年4月15日 3:59 首次提出 将软件系统的计算中枢 进行 AOPM 和 VPCS 维度 不断微分催化成VPCS(功能性神经元函数 2019-04-15- 4:31 首次定义)矩阵, 然后生成 相同数量的 父亲 true 和母亲 false的功能 掩码 DNA 原始肽链, 然后 让其在以后处理过程中 进行自我繁殖进化. 这个过程定义 为 <<类人 数据 催化 环境 与 类人DNA 生命体 繁衍 的 类人计算进化思想>>.
